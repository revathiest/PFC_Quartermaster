        ...
        try {
            ...
            switch (reportType) {
                ...
                case 'channel':
                    ...
                    break;
                default:
                    await interaction.editReply({content: 'Invalid report type.', flags: MessageFlags.Ephemeral});
                    return;
            }

            if (report.length === 0) {
                return interaction.editReply({content: `No data found for ${reportType} report.`, flags: MessageFlags.Ephemeral});
            }
